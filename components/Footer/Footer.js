      ...
      <section className={styles["secondary"]}>
        ...
        <div className={styles["contact"]}>
          ...
          <div className={styles["share-icons"]}>
            <a href={`https://twitter.com/ammduncan`} target="_blank"
               rel="noreferrer" aria-label="See me on Twitter">
            ...
            <a href={`https://www.linkedin.com/in/ammiel-yawson-098902124/`} aria-label="See me on LinkedIn" target="_blank" rel="noreferrer">
              <svg width="40" height="40" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
