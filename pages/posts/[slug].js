            ...
            <div className={classnames(styles["content"])}>
              ...
              <div className={styles["summary"]}>
                ...
                <div className={styles["share-icons"]}>
                  <a href="whatsapp://send?text=The text to share!" data-action="share/whatsapp/share" aria-label="Share on Whatsapp">
                  ...
                  <a href={`https://twitter.com/share?ref_src=twsrc%5Etfw&${query.toString()}`} target="_blank"
                     rel="noreferrer" aria-label="Share on Twitter">
                    <svg width="40" height="40" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                  ...
                  <a href={`https://www.linkedin.com/cws/share?${query.toString()}`} aria-label="Share on LinkedIn" target="_blank" rel="noreferrer">
                    <svg width="40" height="40" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
