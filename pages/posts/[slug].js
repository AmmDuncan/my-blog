    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={post.og_description || post.meta_description || post.excerpt}
        />
        ...
        <meta
          ...
          content={post.twitter_description || post.meta_description || post.excerpt}
        />
        <meta
          name="twitter:image"
            ...
            <div className={classnames(styles["content"])}>
              ...
              <div className={styles["summary"]}>
                ...
                <div className={styles["date-and-time"]}>
                  ...
                  <span className="time">
                    {post.reading_time} min{post.reading_time > 1 ? "s" : null} read
                  </span>
                </div>
                <div className={styles["share-icons"]}>
                  ...
                  <a
                    href={`https://twitter.com/share?ref_src=twsrc%5Etfw&${query.toString()}`}
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className={styles["image"]}>
                ...
                <span
                  className={styles["primary_tag"]}
                  onClick={() => router.push(`/categories/${post?.primary_tag.slug}`)}
                >
